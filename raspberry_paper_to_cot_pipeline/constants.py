...
DEFAULT_PAPER_PROFILER_PRESET = os.getenv('RASPBERRY_PAPER_PROFILER_PRESET', DEFAULT_LWE_PRESET)
DEFAULT_COT_EXTRACTION_PRESET = os.getenv('RASPBERRY_COT_EXTRACTION_PRESET', DEFAULT_LWE_PRESET)
DEFAULT_COT_CRITIQUE_PRESET = os.getenv('RASPBERRY_COT_CRITIQUE_PRESET', DEFAULT_LWE_PRESET)
DEFAULT_COT_REFINEMENT_PRESET = os.getenv('RASPBERRY_COT_REFINEMENT_PRESET', DEFAULT_LWE_PRESET)
DEFAULT_COT_QUALITY_ASSESSOR_PRESET = os.getenv('RASPBERRY_COT_QUALITY_ASSESSOR_PRESET', DEFAULT_LWE_PRESET)
DEFAULT_COT_VOICING_PRESET = os.getenv('RASPBERRY_COT_VOICING_PRESET', DEFAULT_LWE_PRESET)
DEFAULT_COT_VOICING_ASSESSOR_PRESET = os.getenv('RASPBERRY_COT_VOICING_ASSESSOR_PRESET', DEFAULT_LWE_PRESET)
DEFAULT_PAPER_PROFILER_TEMPLATE = os.getenv('RASPBERRY_PAPER_PROFILER_TEMPLATE', "raspberry-paper-profiler.md")
DEFAULT_COT_EXTRACTION_TEMPLATE = os.getenv('RASPBERRY_COT_EXTRACTION_TEMPLATE', "raspberry-cot-extraction.md")
DEFAULT_COT_CRITIQUE_TEMPLATE = os.getenv('RASPBERRY_COT_CRITIQUE_TEMPLATE', "raspberry-cot-critique.md")
DEFAULT_COT_REFINEMENT_TEMPLATE = os.getenv('RASPBERRY_COT_REFINEMENT_TEMPLATE', "raspberry-cot-refine.md")
DEFAULT_COT_QUALITY_ASSESSOR_TEMPLATE = os.getenv('RASPBERRY_COT_QUALITY_ASSESSOR_TEMPLATE', "raspberry-cot-quality-assessor.md")
DEFAULT_COT_VOICING_TEMPLATE = os.getenv('RASPBERRY_COT_VOICING_TEMPLATE', "raspberry-cot-voicing.md")
DEFAULT_COT_VOICING_ASSESSOR_TEMPLATE = os.getenv('RASPBERRY_COT_VOICING_ASSESSOR_TEMPLATE', "raspberry-cot-voicing-assessor.md")
...
# Paths.
DEFAULT_INFERENCE_ARTIFACTS_DIR = Path(os.getenv('RASPBERRY_INFERENCE_ARTIFACTS_DIR', CWD / "results" / "inference"))
DEFAULT_TRAINING_ARTIFACTS_DIR = Path(os.getenv('RASPBERRY_TRAINING_ARTIFACTS_DIR', CWD / "results" / "training"))
...
FETCH_MAX_EMPTY_RESULTS_ATTEMPTS = int(os.getenv('RASPBERRY_FETCH_MAX_EMPTY_ATTEMPTS', 10))

# CoT extraction.
COT_EXTRACTION_DEFAULT_SUITABILITY_SCORE = int(os.getenv('RASPBERRY_COT_EXTRACTION_SUITABILITY_SCORE', 8))

# CoT quality assessment.
COT_QUALITY_ASSESSMENT_DEFAULT_SUITABILITY_SCORE = int(os.getenv('RASPBERRY_COT_QUALITY_ASSESSMENT_SUITABILITY_SCORE', 13))

# CoT voicing assessment.
COT_VOICING_ASSESSMENT_DEFAULT_SUITABILITY_SCORE = int(os.getenv('RASPBERRY_COT_VOICING_ASSESSMENT_SUITABILITY_SCORE', 6))
